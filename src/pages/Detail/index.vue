          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:"
                   class="mins" @click="skuNum>1 ? skuNum-- : skuNum=1">-</a>
              </div>
              <div class="add">
                <!-- 路由跳转并发送请求 -->
...
export default {
  ...
  methods: {
    ...
    async addShopcar(){
      ...
      /*派发了一个action，也向服务器发请求了
      完了需要判断成功还是失败了
      this.$store.dispatch('addOrUpdateShopCart',{skuId:this.$route.params.skuid,skuNum:this.skuNum})
      上面这行代码从仓库中调用了addOrUpdateShopCart
      */
      try {
        await this.$store.dispatch('addOrUpdateShopCart',{skuId:this.$route.params.skuid,skuNum:this.skuNum});
        //2.服务器存储成功---路由跳转
        //4.在路由跳转的时候，将信息带给下一级路由
        //5.产品的信息的数据【skuInfo】,通过绘画存储(不持久化，绘画结束数据才消失)
